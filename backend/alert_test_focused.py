...
class AlertAPITester:
    def __init__(self, base_url: str = "https://consensus-timeline.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing backend at: https://consensus-timeline.preview.emergentagent.com")
