...
class AlertAPITester:
    def __init__(self, base_url: str = "https://spx-core-engine.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing backend at: https://spx-core-engine.preview.emergentagent.com")
